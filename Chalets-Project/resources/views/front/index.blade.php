...
<div class="hero">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="slides">
                    <img src="{{ asset('front/images/hero-slider-1.jpg') }}" alt="Image" class="img-fluid active">
                    <img src="{{ asset('front/images/hero-slider-2.jpg') }}" alt="Image" class="img-fluid">
                    <img src="{{ asset('front/images/hero-slider-3.jpg') }}" alt="Image" class="img-fluid">
                    <img src="{{ asset('front/images/hero-slider-4.jpg') }}" alt="Image" class="img-fluid">
                    <img src="{{ asset('front/images/hero-slider-5.jpg') }}" alt="Image" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row align-items-stretch">
            <div class="col-lg-4 order-lg-1">
                <div class="h-100"><div class="frame h-100"><div class="feature-img-bg h-100" style="background-image: url({{ asset('front/images/hero-slider-1.jpg') }});"></div></div></div>
            </div>
...
<div class="untree_co-section">
    <div class="container">
        ...
        <div class="owl-carousel owl-3-slider">
            ...
            <div class="item">
                <a class="media-thumb" href="{{ asset('front/images/hero-slider-1.jpg') }}" data-fancybox="gallery">
                    <div class="media-text">
                        <h3>Pragser Wildsee</h3>
                        <span class="location">Italy</span>
                    </div>
                    <img src="{{ asset('front/images/hero-slider-1.jpg') }}" alt="Image" class="img-fluid">
                </a>
            </div>

            <div class="item">
                <a class="media-thumb" href="{{ asset('front/images/hero-slider-2.jpg') }}" data-fancybox="gallery">
                    <div class="media-text">
                        <h3>Oia</h3>
            ...
            <div class="item">
                <a class="media-thumb" href="{{ asset('front/images/hero-slider-3.jpg') }}" data-fancybox="gallery">
                    <div class="media-text">
            ...
            <div class="item">
                <a class="media-thumb" href="{{ asset('front/images/hero-slider-4.jpg') }}" data-fancybox="gallery">
                    <div class="media-text">
                        <h3>Rialto Bridge</h3>
                        <span class="location">Italy</span>
                    </div>
            ...
            <div class="item">
                <a class="media-thumb" href="{{ asset('front/images/hero-slider-5.jpg') }}" data-fancybox="gallery">
                    <div class="media-text">
        ...
        <div class="row">
            @foreach($chalets as $chalet)
                <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
                    <div class="media-1">
                        <a href="#" class="d-block mb-3"><img src="{{ asset('uploads/'.$chalet->image->path) }}" alt="Image" class="img-fluid"></a>
                        ...
                        <div class="d-flex align-items-center">
                            <div>
                                <h3><a href="{{ route('elementFront',$chalet->id) }}">{{ $chalet->name }}</a></h3>
                                <div class="price ml-auto">
                                    <span>${{ $chalet->price }}</span>
                                </div>
                            </div>
        ...
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-lg-6">
                <figure class="img-play-video">
                    ...
                    <img src="{{ asset('front/images/hero-slider-2.jpg') }}" alt="Image" class="img-fluid rounded-20">
                </figure>
            </div>
