            ...
            <div class="fun-facts-container">
                ...
                @csrf
                    <div class="col-xl-12 col-md-2">
                        ...
                        <input value="{{$category->name}}" class="with-border" placeholder="name" id="name" name="name" type="text">
                    </div>
                    ...
                    <div class="col-xl-12 col-md-2">
                        ...
                        <textarea class="with-border" rows="5" id="description" name="description" placeholder="Description..."> {{$category->description}} </textarea>
                    </div>
