                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="single-page-header-inner">
                                    <div class="left-side">
                                        <div class="header-image freelancer-avatar"><img src="{{ $freelancer->image_url }}" alt=""></div>
                                        <div class="header-details">
                                            <h3>{{ $freelancer->fname }} {{ $freelancer->lname }}

                                                    <span> {{ $freelancer->profile->specialization??'' }} </span></h3>
                                            <ul>
                                                <li><i class="icon-material-outline-location-on"></i> {{ $freelancer->profile->nationality }} </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-lg-8 content-right-offset">
                                ...
                                <div class="single-page-section">
                                    ...
                                    <p> {{ $freelancer->profile->introduction }} </p>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-4">
                                <div class="sidebar-container">
                                    ...
                                    <div class="sidebar-widget">
                                        <h3>Skills</h3>
                                        <div class="task-tags">
                                            @foreach($freelancer->profile->tag as $tag)
