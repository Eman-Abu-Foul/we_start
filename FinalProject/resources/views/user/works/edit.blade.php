                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="submit-field">
                                                <h5>Work Title</h5>
                                                <input name="title" value="{{ $work->title }}" id="title" type="text" class="with-border">
                                            </div>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="submit-field">
                                                <h5>Job Description</h5>
                                                <textarea name="description" id="description" cols="30" rows="5" class="with-border">{{ $work->description }}</textarea>
                                                ...
                                                <div class="uploadButton margin-top-30">
                                                    ...
                                                    <img width="80px" src="{{ asset($work->image->path) }}">
                                                </div>
                                            </div>
                                        </div>
...
@section('scripts')
    <script>
        ...
        function performStore() {
            ...
            axios.post('/works/{{$work->id}}', formData , config)
