                                    ...
                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-6">
                                                        <div class="input-with-icon">
                                                            <input class="with-border" name="min" id="min" type="number" placeholder="Min">
                                                            <i class="currency">USD</i>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="input-with-icon">
                                                            <input class="with-border" name="max" id="max" type="number" placeholder="Max">
                                                            <i class="currency">USD</i>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="submit-field">
                                                ...
                                                <input name="date" id="date" class="with-border" type="text">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="submit-field">
                                                ...
                                                <textarea cols="30" id="description" rows="5" class="with-border"></textarea>
                                                <h5>Attachments</h5>
