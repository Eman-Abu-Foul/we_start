        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu {{ active('invitations', 'menu-open') }}">
                        <a href="#" class="nav-link {{ active('invitations') }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href=" {{ route('admin.invitations.index') }} " class="nav-link {{ active('admin.invitations.index') }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>All Invitations</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.invitations.create') }}" class="nav-link {{ active('admin.invitations.create') }}">
                                    <i class="far fa-circle nav-icon"></i>
